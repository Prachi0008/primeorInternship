# Primeor Internship
These are the tasks assigned for my frontend development role at Primeor Solutions Pvt. Ltd.
...
- Paragraph
- Image
- Background colors & proper spacing
▪ Build a clean form with:
- Input field
- Submit button
- Basic CSS styling
▪ Design a responsive navigation menu with:
- Home
- About
- Contact links
- Hover effects & alignment styling
...
▪ Implement a simple image slideshow that
automatically transitions between images using
HTML and CSS.
▪ Add smooth hover effects and transitions to
images.

LEVEL 3 - TASK 2:
Create a landing page for a Web Developer Internship Program with the following key elements:
▪ Clear headline: “Web Developer Internship Program at
Primeor Solutions”
▪ Brief introduction: Overview of the internship program
and duration.
▪ Highlights:
Benefits of the internship such as:
- Real-world experience
- Portfolio development
- Practical frontend exposure
- Hands-on projects
